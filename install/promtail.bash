...
PROMTAIL_BIN_URL="https://github.com/grafana/loki/releases/download/v$PROMTAIL_VERSION/$PROMTAIL_BIN_FILENAME.zip"
...
# Step 9: Verify if Promtail is running
echo "Checking if Promtail is running..."
